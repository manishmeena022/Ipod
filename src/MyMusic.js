...
import sound from './assets/music/_Pehli Baarish Mein_320(PagalWorld.com.se).mp3'
        ...
        return(
            <div style={styles.myMusicContainer}>
                ...
                <div style={styles.info}>
                    <img style={styles.image} src="https://c.saavncdn.com/666/Pehli-Pehli-Baarish-Hindi-2022-20220720010703-500x500.jpg" alt='music'></img>
                    <div style={styles.subInfo}>
                        <h4 style={{marginBottom:'0.5rem'}}>Phali Baarish Mein</h4>
                        <p style={{marginBottom:'0'}}>AsimR</p>
                        <p>Sumit Bhalla</p>
                    </div>
